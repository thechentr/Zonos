...
def generate_audio(
    ...
    speaker_audio,
    prefix_audio=None,
    emotions=[1.0000, 0.0500, 0.0500, 0.0500, 0.0500, 0.0500, 0.05000, 0.05000],
    vq_single=0.78,
    fmax=24000,
    pitch_std=45,
    speaking_rate=1,
    ...
    logging.info(f"emotions: {emotions}")
...
def build_interface():
    ...
    with gr.Blocks() as demo:
        ...
        # warm up
        logging.info(f"warmed up ......")
        with Timer('warm up'):
            for _ in range(3):
                for _ in generate_audio(
                    text=text.value,
